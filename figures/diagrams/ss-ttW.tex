...
\begin{tikzpicture}
  \begin{feynman}
% \diagram [nodes=circle, small, horizontal=v1 to v2, tree layout] {
%   {z1 - z2, v1 -- v2 -- {v3 -- {p1, p2}, v4 -- {p3, p4}}},
% };
%     \vertex[above=of v1] (v7);
%     \vertex[above left=of v7] (p7) {\(\overline \Pq^\prime\)};
%     \vertex[above right=of v7] (v8);
%     \vertex[above right=of v8] (p8) {\(\nu\)};
%     \vertex[below right=of v8] (p9) {\(\Plep^+\)};
%     \vertex[below left=of v1] (p10) {\(\Pq\)};
